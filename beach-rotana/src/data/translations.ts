...
export const TRANSLATIONS: Record<Lang, Translations> = {
  en: {
    ...
    moods: {
      ...
      'drinks-atmosphere': { label: 'Evening ambience',          sub: 'Atmosphere, lounge & social setting' },
    ...
    cravings: {
      ...
      cocktails:         'Mocktails & refreshments',
      shisha:            'Shisha',
  ...
  ar: {
    ...
    moods: {
      ...
      'drinks-atmosphere': { label: 'أجواء المساء',              sub: 'لاونج وتواصل اجتماعي' },
